...
//    }
    ...
    private StatusCode addDoctorUser(Doctor doctor) {
    ...
    private StatusCode addPatientUser(Patient patient) {
        String sql = "INSERT INTO users (id, firstName, lastName, email, passwordHash, address, phone, role, pfp, " +
    ...
    public User loginUser(String email, String password) {
        ...
        boolean isAuthenticated = UserAuthUtil.authenticateUser(password, hashedPassword);
